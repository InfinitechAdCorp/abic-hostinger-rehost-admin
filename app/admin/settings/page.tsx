...
export default function Settings() {
  ...
  return (
    <section className="py-12 px-4 md:px-12">
      <div className="py-8">
        <div>
          <h1 className="text-3xl font-bold text-violet-800 uppercase">
            Settings
          </h1>
          <Breadcrumbs isDisabled>
            ...
            <BreadcrumbItem isCurrent>
              {breadcrumbLabels[selectedTab] || "Settings"}
            </BreadcrumbItem>
          </Breadcrumbs>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 py-12">
          {/* Sidebar Navigation */}
          <div className="w-full md:w-1/4 py-2 px-4 flex flex-col border-b md:border-r border-default-200 dark:border-default-100">
